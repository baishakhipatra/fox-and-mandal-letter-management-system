                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Permissions
                            ...
                            <!--<a href="{{ url('permissions/create') }}" class="btn btn-cta float-end">Add Permission</a>-->
                            <!--@endcan-->
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="index-col">{{ $permission->id }}</td>
                                    <td>{{ $permission->name }}</td>
                                    <td>
                                        @can('update permission')
                                        <a href="{{ url('permissions/'.$permission->id.'/edit') }}" class="btn btn-cta">
                                        ...
                                        <a href="{{ url('permissions/'.$permission->id.'/delete') }}" class="btn btn-cta">
