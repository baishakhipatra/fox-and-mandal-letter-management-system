            ...
            <div class="col-md-12">
                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Office
                            @can('create office')
                            <a href="{{ url('offices/create') }}" class="btn btn-sm btn-cta float-end">Add Office</a>
                            @endcan
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('update office')
                                        <a href="{{ url('offices/'.$item->id.'/edit') }}" class="btn btn-cta">
                                        ...
                                        @can('delete office')
                                        <a href="{{ url('offices/'.$item->id.'/delete') }}" class="btn btn-cta">
