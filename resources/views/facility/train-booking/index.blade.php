                                        ...
                                        @foreach ($formattedTravellers as $key => $traveller)
                                            ...
                                            <tr>
                                                @if ($key == 0)
                                                    ...
                                                    <td rowspan="{{ count($formattedTravellers) }}">{{ $item->travel_date }}</td>
                                                ...
                                                @if ($key == 0)
                                                    ...
                                                    <td rowspan="{{ count($formattedTravellers) }}">{{ $item->matter_code }}</td>
                                                    <td rowspan="{{ count($formattedTravellers) }}">{{ $item->purpose_description ?? '' }}</td>
