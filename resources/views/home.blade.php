    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="card shadow-sm d-flex flex-row align-items-center justify-content-between new-card-design orange-bg">
                    <div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card shadow-sm d-flex flex-row align-items-center justify-content-between new-card-design blue-bg">
                    <div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card shadow-sm d-flex flex-row align-items-center justify-content-between new-card-design green-bg">
                    <div>
            ...
            @if($role === 'super admin')
                <div class="col-md-3 mb-4">
                    <div class="card shadow-sm  d-flex flex-row align-items-center justify-content-between new-card-design dkblue-bg">
                        <div>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-sm d-flex flex-row align-items-center justify-content-between new-card-design yellow-bg">
                        <div>
