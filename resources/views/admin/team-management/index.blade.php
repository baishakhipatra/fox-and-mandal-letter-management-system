                            ...
                            <tbody>
                                @foreach($teams as $team)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-primary editTeamBtn" data-id="{{ $team->id }}" data-bs-toggle="tooltip" data-bs-title="Edit">
                                                <i class="fa fa-pen"></i>
                                            </button>

                                            <button class="btn btn-sm btn-outline-danger deleteTeamBtn" data-id="{{ $team->id }}" data-bs-toggle="tooltip" data-bs-title="Delete">
