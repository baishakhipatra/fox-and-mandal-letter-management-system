            ...
            <div class="col-md-12">
                ...
                <div class="card data-card">
                    <div class="card-header">
                        <h4 class="d-flex">Edit Cavity Location
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-8 col-12">
                                <form action="{{ url('vaultlocations/'.$data->id) }}" method="POST" class="data-form">
                                    @csrf
                                    @method('PUT')
        
                                    <div class="mb-3">
                                        <label for="">Location</label>
                                        <input type="text" name="location" class="form-control" value="{{$data->location}}"  placeholder="Enter location"/>
                                    </div>
