            ...
            <div class="col-md-12">
                ...
                <div class="card data-card">
                    <div class="card-header">
                        <h4 class="d-flex">Edit Vault Category
                            <a href="{{ url('vaultcategories') }}" class="btn btn-cta ms-auto">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-8 col-12">
                                <form action="{{ url('vaultcategories/'.$data->id) }}" method="POST" class="data-form">
                                    @csrf
                                    @method('PUT')
        
                                    <div class="mb-3">
                                        <label for="">Location</label>
                                        <select class="form-select form-select-sm" aria-label="Default select example" name="location_id" id="office_id">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{$data->name}}"  placeholder="Enter Title"/>
                                    </div>
