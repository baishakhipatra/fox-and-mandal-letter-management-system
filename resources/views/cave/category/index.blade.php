            ...
            <div class="col-md-12">
                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4 class="d-flex">Cavity Room List
                            @can('create cavity room')
                            <a href="{{ url('vaultcategories/create') }}" class="btn btn-sm btn-cta ms-auto">Add Cavity Room</a>
                            @endcan
                        </h4>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('update cavity room')
                                            <a href="{{ url('vaultcategories/'.$item->id.'/edit') }}" class="btn btn-cta">
                                            ...
                                            <a href="{{ url('vaultcategories/'.$item->id) }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('delete cavity room')
                                            <a onclick="return confirm('Are you sure ?')" href="{{ route('vaultcategories.delete', $item->id) }}" class="btn btn-cta">
