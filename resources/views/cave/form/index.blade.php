            ...
            <div class="col-md-12">
                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4 class="d-flex">Cavity List
                            @can('create cave form')
                            <a href="{{ url('vaults/create') }}" class="btn btn-sm btn-cta ms-auto">Add Cavity</a>
                            @endcan
                            @can('vault csv download')
                            <a href="{{ route('vaults.export.csv',['date_from'=>$request->date_from,'date_to'=>$request->date_to,'keyword'=>$request->keyword]) }}" class="btn btn-sm btn-cta ms-auto" data-bs-toggle="tooltip" title="Export data in CSV">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><!-- QR Code Display -->
                                            ...
                                            <!-- Print Button -->
                                            <a class="btn btn-sm btn-danger print_btn" data-bs-toggle="tooltip" title="Print QR" onclick="printQRCode('{{ $item->id }}','{{ $item->unique_code }}','{{ $item->qrcode }}')">
                                        ...
                                        <td>
                                            @can('update cave form')
                                            <a href="{{ url('vaults/'.$item->id.'/edit') }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('view cave form')
                                            <a href="{{ url('vaults/'.$item->id) }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('delete cave form')
                                            <a onclick="return confirm('Are you sure ?')" href="{{ route('vaults.delete', $item->id) }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('take out list')
                                            <a href="{{ url('vaults/'.$item->id.'/takeout/list') }}" class="btn btn-cta">Issued User</a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @endforeach
