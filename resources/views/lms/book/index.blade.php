                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4 class="d-flex">
                            ...
                            @endcan
                            <a href="#bulkcsvModal" data-bs-toggle="modal" class="btn btn-sm btn-cta"> Bulk Book Update</a>
                            <a href="#bulkbookdeletecsvModal" data-bs-toggle="modal" class="btn btn-sm btn-cta"> Bulk Book Delete</a>
                            @can('create book')
                            <a href="{{ url('books/create') }}" class="btn btn-sm btn-cta">Add Books</a>
                            @endcan
                        </h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            @can('update book')
                                            <a href="{{ url('books/'.$item->id.'/edit') }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('view book')
                                            <a href="{{ url('books/'.$item->id) }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('book issue list')
                                            <a href="{{ url('books/'.$item->id.'/issue/list') }}" class="btn btn-cta">Issued User</a>
                                            @endcan
                                            @can('book history')
                                            <a href="{{ url('books/'.$item->id.'/history') }}" class="btn btn-cta">History</a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @empty
