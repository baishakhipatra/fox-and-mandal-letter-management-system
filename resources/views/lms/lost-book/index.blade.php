                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            @can('update lost book list')
                                            <a href="{{ url('lostbooks/'.$item->id.'/edit') }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('view lost book list')
                                            <a href="{{ url('lostbooks/'.$item->id) }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('delete lost book list')
                                            <a onclick="return confirm('Are you sure ?')" href="{{ url('lostbooks/'.$item->id.'/delete') }}" class="btn btn-cta">
